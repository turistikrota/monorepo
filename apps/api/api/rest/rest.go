...
import (
	...
	"github.com/turistikrota/api/api/rest/routes"
	...
	"github.com/turistikrota/api/pkg/server"
...
func New(cnf Config) server.Listener {
	...
	return srv{
		...
		fiber: fiber.New(fiber.Config{
			...
			AppName:        "turistikrota",
			ServerHeader:   "turistikrota",
...
func (s srv) Listen() error {
	...
	s.fiber.Use(otelfiber.Middleware(otelfiber.WithServerName("turistikrota"), otelfiber.WithCollectClientIP(true)))
